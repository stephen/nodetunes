...
var challenge = 'j/EVgkqsq3gWB+RS/5nydg==';
console.log(tools.getAppleResponse(challenge));
...
var server = function() {
	...
	var parse = function(socket, msg) {
		...
		if (directive == 'OPTIONS') {
			...
			response.addHeader('Apple-Response', tools.getAppleResponse(headers['Apple-Challenge']));
